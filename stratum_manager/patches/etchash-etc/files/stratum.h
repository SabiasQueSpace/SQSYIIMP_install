...
extern bool is_ethash;
extern bool is_etchash;
...
extern char g_stratum_coinbaseextra[MAX_COINBASE_EXTRA];
...
extern double g_stratum_mrr_difficulty;
extern double g_stratum_mrr_min_diff;
extern double g_stratum_mrr_max_diff;
...
extern bool g_debuglog_verbose;

extern uint64_t g_max_shares;
extern uint64_t g_shares_counter;
extern uint64_t g_shares_accepted_counter;
extern uint64_t g_shares_rejected_counter;
extern uint64_t g_reject_low_diff_counter;
extern uint64_t g_reject_stale_counter;
extern uint64_t g_reject_duplicate_counter;
extern uint64_t g_reject_invalid_counter;
extern uint64_t g_reject_other_counter;

extern int g_observability_rpc_warn_ms;
extern int g_observability_rpc_critical_ms;
extern int g_observability_rpc_slow_streak;
extern int g_observability_summary_interval;
extern bool g_observability_log_shares;
